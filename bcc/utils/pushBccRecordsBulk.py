...
Objectives: 
    - Push existing BCC Traffic records in 5 traffic-related collections to Optimum VM mongoDB 
    ...
    - Notes: 
        ...
        - This script should be run once only to migrate most of the records to Intrasoft VM
