# -*- coding: utf-8 -*-
"""
Created on Mon Mar 21 2016

@author: Ahmad

Objectives: 
    - Push existing BCC_traffic records on Optimum VM server mongoDB in 5 traffic-related collections 
        to BccTraffic Optimum VM server mongoDB 
